...
public static class WebhookSender
{
    ...
    {
        string url = MainClass.singleton.Config.Webhooks[type];
    ...
    private static readonly Dictionary<WebhookType, List<string>> MsgQueue = new() {[WebhookType.CommandLogs] = new List<string>(), [WebhookType.GameLogs] = new List<string>(), [WebhookType.ConsoleCommandLogs] = new List<string>()};
